...
class Restaurants() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<Restaurants> {
        override fun createFromParcel(parcel: Parcel): Restaurants {
            return Restaurants(parcel)
        }

        override fun newArray(size: Int): Array<Restaurants?> {
